...
def display_result():
    ...
    # Call the colorize_grayscale_images function
    colorize_grayscale_images(input_files, output_folder)

    return "Colorization completed!"  # Display a message indicating the completion of the colorization process

def colorize_grayscale_images(input_paths, output_folder):
    # Your existing code for colorizing grayscale images
